...
## Nature communication
nc_df<- data.frame(years,nc_aff,nc_gl)
...
## PLOS ONE
po_df<- data.frame(years,po_aff,po_gl)
...
## Scientific Reports
sr_df<- data.frame(years,sr_aff,sr_gl)
...
## BMC_Genomics
bg_df<- data.frame(years,bg_aff,bg_gl)
...
## PLoS Genetics
pg_df<- data.frame(years,pg_aff,pg_gl)
...
## Oncotarget
ot_df<- data.frame(years,ot_aff,ot_gl)
