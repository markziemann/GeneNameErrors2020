...
affected_pubb <- c(affected_pub_at,affected_pub_celegans,affected_pub_drerio,
...
proportion_species <- c(percentage_at,percentage_celegans,percentage_drerio,percentage_ggallus,
...
## Now a look at the number of affected publications in different journals
...
plot(df_oncotarget,ylab="number of articles with gene name errors",
  xlab="years",ylim=c(0,80),type="b",pch=19,bty="n",
  main="Papers with gene name errors in Oncotarget from 2014 to 2020",cex.main=1)
grid()
